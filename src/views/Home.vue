...
<template>
  <div v-if="error">
    <span
      class="w-[50%] lg:w-[20%] h-[3rem] flex justify-center items-center relative bottom-[50%] left-[50%] z-10 lg:px-6 py-4 lg:py-2 bg-gradient-to-r from-slate-800 to-slate-900 text-rose-500 border border-rose-500 rounded-md"
